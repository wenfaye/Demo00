// @ts-nocheck
/**
 * Base on https://github.com/umijs//Volumes/文件/工作区01/Demo02/umi3Example/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/Volumes/文件/工作区01/Demo02/umi3Example/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/Volumes/文件/工作区01/Demo02/umi3Example/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/Volumes/文件/工作区01/Demo02/umi3Example/node_modules/@ahooksjs/use-request/lib/types';
